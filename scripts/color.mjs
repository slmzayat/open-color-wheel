/**
 * Open Color Wheel — color math
 *
 * Every pure function the build depends on, with no I/O and no shared state,
 * so test/color.test.mjs can import it without running a build. scripts/build.mjs
 * reads the spec and orchestrates; this file does the arithmetic.
 */
...
function nearestHue(hues, targetAngle, excludeName) {
